...
imgs[0]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768080209/oskiwedding_remix3_pfykpv.png')
...
imgs[3]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768079805/JulieShirt_dg5sp5.png')
    ...
    imgs[6]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768080037/oskiwedding_remix7_dwmomj.png')
    imgs[7]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768079117/oskiwedding_remix_eem8uf.png')
    ...
    imgs[11]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1702358536/dUMBYDUMBY6_la4pud.png')
    imgs[12]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1686184080/BanShirt_xu0h0w.png')
        imgs[13]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768079436/blue_qc4krj.png')
    imgs[14]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768079117/oskiwedding_remix4_jpa4nm.png')
    ...
    imgs[21]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1768972743/Voldemort_FourBySixSticker1_irsevu.png')
        ...
        // imgs[24]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1769188185/Voldemort_FourBySixSticker111111111_guxjqu.png')
