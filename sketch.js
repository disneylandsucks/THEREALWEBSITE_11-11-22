...
imgs[0]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1665773929/SCREENPRINT_Shirt_resized_ujjqp1.png')
 imgs[1] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1665773929/voldemort_shirt_resized_ytqhl7.png') 
    ...
    imgs[3]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1702358536/dUMBYDUMBY6_la4pud.png')
    imgs[7]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1669922804/ChaeyoungFromTwice_ImTryingtoDate_vftqn8.png')
    ...
    imgs[9]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1686163503/EdSheeranShirt_ttl0k2.png')
    ...
    // imgs[6]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1676747715/Clay_Club_SHirts_e1xomb.png')
    // imgs[6]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1676747715/Clay_Club_SHirts_e1xomb.png')
